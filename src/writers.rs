...
pub(crate) async fn write_eof_packet(w: &mut PacketWriter, s: StatusFlags) -> io::Result<()> {
...
pub async fn write_err(err: ErrorKind, msg: &[u8], w: &mut PacketWriter) -> io::Result<()> {
    w.write_u8(0xFF)?;
...
pub(crate) async fn write_column_definitions<'a, I>(
    i: I,
    w: &mut PacketWriter,
...
pub(crate) async fn column_definitions<'a, I>(i: I, w: &mut PacketWriter) -> io::Result<()>
where
    I: IntoIterator<Item = &'a Column>,
